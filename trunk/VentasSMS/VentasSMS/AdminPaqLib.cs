...
namespace VentasSMS
{
    public class AdminPaqLib
    {
        ...
        [DllImport("DBFWIN32")]
        public static extern int dbFieldDouble(long hDbc, string fileName, int nField, ref double lpLong);
        [DllImport("DBFWIN32")]
        public static extern long dbGet(long hDbc, string fileName, string TagName, string Key);
        [DllImport("DBFWIN32")]
        public static extern long dbGetNoLock(long hDbc, string fileName, string TagName, string Key);
        [DllImport("DBFWIN32")]
