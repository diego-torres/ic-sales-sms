DROP TABLE IF EXISTS sys_sms_settings CASCADE;
CREATE TABLE sys_sms_settings
(
	friExecuted varchar(20) default '',
	friSchedule	varchar(20) default 'false',
	monExecuted varchar(20) default '',
	monSchedule	varchar(20) default 'false',
	sms_password varchar(50) default '',
	satExecuted varchar(20) default '',
	satSchedule	varchar(20) default 'false',
	sunExecuted varchar(20) default '',
	sunSchedule	varchar(20) default 'false',
	thuExecuted varchar(20) default '',
	thuSchedule	varchar(20) default 'false',
	todSchedule	varchar(250) default '',
	tueExecuted varchar(20) default '',
	tueSchedule	varchar(20) default 'false',
	sms_user varchar(50) default '',
	wedExecuted varchar(20) default '',
	wedSchedule	varchar(20) default 'false'
);
...
CREATE TABLE dim_sellers(
	...
	agent_code VARCHAR(10) default '',
	agent_name VARCHAR(150) default '',
	phone VARCHAR(10) default '',
	cellphone character varying (150) default '',
...
(
  ...
  director_name character varying(150) default '',
